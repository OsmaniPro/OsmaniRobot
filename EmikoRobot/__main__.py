...
PM_START_TEXT = """
*Hello {} !*
✪ Waxaan ahay bot maamulka mawduuca animeme [✨](https://telegra.ph/file/68a54bd804d7b4a3c6f64.jpg)
────────────────────────
× *Uptime:* `{}`
× `{}` *users, across* `{}` *chats.*
────────────────────────
...
buttons = [
    [
        InlineKeyboardButton(text="About Osmani Robot", callback_data="emiko_"),
    ],
    [
    ...
    [
        InlineKeyboardButton(
            text="➗ Add Osmani To Your Group ➗", url="t.me/EmiexRobot?startgroup=new"),
    ],
]
...
EMI_IMG = "https://telegra.ph/file/02e51c229a2867e13c21e.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project by contacting @meribaj \
...
def emiko_about_callback(update, context):
    ...
    if query.data == "emiko_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 ...
                 [
                    InlineKeyboardButton(text="Source Code", url="https://github.com/Ribaj"),
                 ],
                 [
        ...
        query.message.edit_text(
            ...
            "\nCongragulations, OsmaniRobot now ready to manage your group."
            "\n\n*Admin Tools*"
        ...
        query.message.edit_text(
            ...
            "\nHere Developers Making And Give Inspiration For Made The OsmaniRobot",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Me-Ribaj", url="https://github.com/Ribaj"),
                    InlineKeyboardButton(text="Jabir", url="https://github.com/jaabirosman"),
                 ],
                 [
                    InlineKeyboardButton(text="Rosan", url="https://github.com/rosanlent"),
